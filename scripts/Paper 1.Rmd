...
input.bom.rain <- read.csv("R:/SET/PlantSci/Shared Work Spaces/Ecology/Peoples files/Marion Nyberg/PhD/SP warming experiment/Interlaken_BOM_rainfall.csv") %>% #filter(Year >= 2010 & Year <= 2019) %>% # used all years available due to missing data 1995 - 2021
